            ...
            <div class="bg-white rounded">
                ...
                <div class="grid grid-cols-2">
                    <div class="p-4 border-r flex flex-col place-content-center place-items-center">
                        ...
                        <div class="w-32 h-32 rounded-full border mt-2 bg-emerald-600 flex place-content-center place-items-center shadow-md md:w-64 md:h-64">
                            <p class="w-24 h-24 border rounded-full bg-emerald-400 flex place-content-center place-items-center text-2xl md:w-40 md:h-40">{{ getQuantity }}</p>
                        </div>
                    </div>
